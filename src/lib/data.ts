...
const getImage = (id: string) => {
  ...
  return image || { imageUrl: 'https://picsum.photos/seed/placeholder/300/300', imageHint: 'placeholder' };
}
...
const products: Product[] = [
  ...
  { id: '2', name: 'Organic Bananas', description: 'A bunch of ripe, organic bananas.', price: 1.99, imageId: 'prod-2', storeId: '1' },
  { id: '3', name: 'Sourdough Bread', description: 'Artisanal sourdough, baked fresh daily.', price: 5.49, imageId: 'prod-3', storeId: '1' },
  { id: '4', name: 'Organic Milk', description: '1 gallon of whole organic milk.', price: 4.99, imageId: 'prod-4', storeId: '1' },
  { id: '5', name: 'Free-Range Eggs', description: 'A dozen large, brown free-range eggs.', price: 3.99, imageId: 'prod-5', storeId: '1' },

  // City Fresh Produce
  { id: '6', name: 'Carrots', description: 'A bunch of fresh, sweet carrots.', price: 1.49, imageId: 'prod-6', storeId: '2' },
  { id: '7', name: 'Romaine Lettuce', description: 'A head of crisp romaine lettuce.', price: 2.29, imageId: 'prod-7', storeId: '2' },
  { id: '8', name: 'Vine Tomatoes', description: 'Juicy tomatoes, still on the vine.', price: 3.49, imageId: 'prod-8', storeId: '2' },
  { id: '2', name: 'Bananas', description: 'A bunch of ripe bananas.', price: 1.89, imageId: 'prod-2', storeId: '2' },
  { id: '1', name: 'Gala Apples', description: 'Sweet and crunchy Gala apples.', price: 2.79, imageId: 'prod-1', storeId: '2' },
  ...
  { id: '11', name: 'Greek Yogurt', description: 'Plain Greek yogurt, 32oz tub.', price: 5.99, imageId: 'prod-11', storeId: '3' },
  { id: '12', name: 'Spaghetti Pasta', description: '16oz box of spaghetti.', price: 1.99, imageId: 'prod-12', storeId: '3' },
  { id: '13', name: 'White Rice', description: '2 lb bag of long-grain white rice.', price: 3.29, imageId: 'prod-13', storeId: '3' },
  { id: '14', name: 'Corn Flakes Cereal', description: '18oz box of classic corn flakes.', price: 3.79, imageId: 'prod-14', storeId: '3' },
  { id: '15', name: 'Orange Juice', description: 'Half-gallon of not-from-concentrate orange juice.', price: 4.29, imageId: 'prod-15', storeId: '3' },
  { id: '4', name: 'Whole Milk', description: '1 gallon of whole milk.', price: 4.79, imageId: 'prod-4', storeId: '3' },
];
